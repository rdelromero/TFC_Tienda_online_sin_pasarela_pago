let numeroImagenAlCargar = 0;
        ...
        window.onload = function() {
          ...
          divDeImagenes.style.width = `${100 * numeroDiapositivas / numeroDiapositivasVisibles}%`;
          ...
          spans = document.querySelectorAll(".contenedor2 span");
        ...
        function irADiapositivaActual() {
          ...
          divDeImagenes.style.transform="translateX("+porcentaje+"%)";
